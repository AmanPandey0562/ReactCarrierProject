...
@Component({
  selector: 'app-origin-pir-chart',
  templateUrl: './origin-pir-chart.component.html',
  styleUrls: ['./origin-pir-chart.component.css']
})
export class OriginPirChartComponent implements OnInit {
